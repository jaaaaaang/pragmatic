...
from accountapp.views import hello_world, test, AccountCreateView, AccountDetailView, AccountUpdateView, trafficmap, trmap
...
urlpatterns = [
    ...
    path('trafficmap/', trafficmap, name = 'trafficmap'),
    path('trmap/', trmap, name='trmap'),
